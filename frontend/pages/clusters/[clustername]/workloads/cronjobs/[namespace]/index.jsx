...
import { ageColumn, nameColumn } from '@/lib/workloadColumns';
import { formatAge } from '@/lib/resourceHighlights';

export default function NamespacedCronJobs() {
  const clusterName = useParams()?.clustername;
  const namespace = useParams()?.namespace;

  return (
    <>
      <PageHeader title="CronJobs" subtitle={`${clusterName} / ${namespace}`} />
      <DataTable
        agent={clusterName}
